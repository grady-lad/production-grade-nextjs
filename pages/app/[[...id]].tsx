...
const App: FC<{ folders?: any[]; activeFolder?: any; activeDoc?: any; activeDocs?: any[] }> = ({
  ...
  const handleNewFolder = async (name: string) => {
    /**
     * If you want to access .env vars on the client they need to prefixed with "NEXT_...." like Create-react-app
     */
    ...
    // update local state. Queue up the updating of the state correctly by using a function.
