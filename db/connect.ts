 ...
 * better.
 *
 * The DB will be cached. Even though we are using serverless functions AWS will most likely spin up
 * the functions within the same container which is where this DB gets cached to.
 */
